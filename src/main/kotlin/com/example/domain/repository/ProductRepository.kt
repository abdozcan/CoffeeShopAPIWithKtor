...
interface ProductRepository {
    suspend fun all(limit: Int, offset: Long, sortOption: ProductSortOption): Result<List<Product>>
    ...
    suspend fun findBestsellers(limit: Int, offset: Long, sortOption: ProductSortOption): Result<List<Product>>
